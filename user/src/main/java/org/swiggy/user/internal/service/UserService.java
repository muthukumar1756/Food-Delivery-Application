...
public interface UserService {
     ...
     */
    User getUser(final UserData userDataType, final String userData, final String password);
     ...
     */
    boolean updateUserData(final long userId, final UserData type, final String userData);
}
