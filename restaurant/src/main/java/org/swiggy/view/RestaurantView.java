...
public class RestaurantView extends CommonView {
    ...
    private void addFood(final long restaurantId) {
        ...
        restaurantController.loadFoodData(new Food(name, rate, getType(), quantity), restaurantId);
        displayHomePageMenu(restaurantId);
    }
    ...
    private FoodType getType() {
        logger.info("""
                ...
                1.Veg
                2.NonVeg""");
        final FoodType foodType = FoodType.getTypeById(getValue());
